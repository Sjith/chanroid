...
public abstract class CCBaseAdapter<T> extends SimpleAdapter {

	private Context mContext;
	private int mLayoutId;
	private List<T> mData;

	private CCBaseAdapter(Context context, List<? extends Map<String, ?>> data,
	...
	public CCBaseAdapter(Context context, int resource, List<T> data) {
