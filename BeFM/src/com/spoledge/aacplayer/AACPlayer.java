...
/**
 * This is the AACPlayer parent class. It uses Decoder to decode AAC stream into
 * PCM samples. This class is not thread safe.
 */
public abstract class AACPlayer {
	...
	private static final String LOG = "eFM BUSAN";
...
//		}.execute();
	 ...
	 */
	protected abstract void playImpl(InputStream is, int expectedKBitSecRate)
			throws Exception;
